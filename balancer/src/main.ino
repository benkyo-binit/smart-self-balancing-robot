...
int acc_calibration_value = -8231;                            //Enter the accelerometer calibration value

//Various  settings
float pid_p_gain = 16.4832;                                      //p = 16.5
float pid_i_gain = 1.15;                                      //i = 1.15
float pid_d_gain = 26;                                     //d = 24.2
float turning_speed = 900;                                    //Turning speed (900)
float max_target_speed = 1500;                                //Max target speed (1500)
